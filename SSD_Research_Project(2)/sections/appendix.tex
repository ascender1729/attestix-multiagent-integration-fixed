...
\addcontentsline{toc}{section}{Appendix A --- Hospital Unregulated Baseline Run}
...
\addcontentsline{toc}{section}{Appendix B --- Raw Provenance Log}
...
\addcontentsline{toc}{section}{Appendix C --- Blockchain Transaction CSV Export}
...
A full four-pipeline sweep consumes approximately 1.58\% of the Groq free-tier daily budget (1{,}000{,}000 tokens). On the paid tier, the upper-bound cost per sweep is approximately USD 0.0125.
